...
<head>\n\
  ...
  <style>body{margin:25px;font-family:"Helvetica Neue", Arial, Helvetica, Geneva, sans-serif;font-size: 13px;}</style>\n\
  <script src=""></script>\n\
</head>\n\
<body>\n\
  <h1>Main Title</h1>\n\
 ...
 * Dated: ' + now + '\n\
 */\n\
public class nodedit {\n\
\tpublic static void main(String[] args) {\n\
\tSystem.out.printf("Hello, World with %d args\\n", args.length);\n\
\t// Your code...\n\
\t}\n\
}',
						pos: {line: 8, ch: 1},
